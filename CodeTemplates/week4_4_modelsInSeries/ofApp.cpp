...
void ofApp::update() {
    ...
    /* TODO: update the radius parameter with the audio rms values */
...
void ofApp::audioOut(ofSoundBuffer& output) {
    ...
    for (int i = 0; i < output.getNumFrames(); ++i) {
        ...
        /* FFT Analysis */
        /* TODO:    send the audio signal to the fft for processing,
                    convert the frequency magnitudes to db values */

        /* RMS Analysis */
        /* TODO:    send the audio signal to the rapidStream object
                    and calculate the rms values */
...
void ofApp::keyReleased(int key) {
    ...
    if (key == 't' || key == 'T') {
        ...
        /* TODO:    Train the graphics neural network with the data from the
                    training set */
...
void ofApp::mouseDragged(int x, int y, int button) {
    ...
    /* TODO:    Declare training input and output vectors for the 
    ...
    if (isRecording && !isTrained) {
        ...
        /* TODO:    retrieve the db values of each frequency bin, set max val 120, 
                    normalise and store in the training input vector */
        
        /* TODO:    Store the normalised graphics parameters in the training output vector */

        /* TODO:    Create a temporary training example object, assign the input and output
                    to the training vectors, add to the global training set */
    ...
    if (isRunning && isTrained) {
        ...
        /* TODO:    Retrieve the db values of each frequency bin, set max val 120, 
                    normalise and store in the input vector. Then run the graphics
                    neural network on the input data. */
