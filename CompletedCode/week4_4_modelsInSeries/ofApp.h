...
public:
	...
	/* RapidLib */
	std::vector<rapidlib::trainingExample> data, graphicsTrainingSet;
	std::vector<double> modelOutput, graphicsModelOut;
	rapidlib::regression neuralNet, graphicsNeuralNet;
	bool isRecording;
	bool isTrained;
	bool isEmpty;
	bool isRunning;
	...
	rapidlib::rapidStream<double> rapidStream;
	double rms;
